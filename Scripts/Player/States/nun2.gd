class_name PlayerNun2State
extends PlayerAttackState

func enter():
	super()
	player.animation.play(nun2_anim)
...
func _ready():
	...
	hitbox.KNOCKBACK = -5
	current_state = "nun2"
	combo_chain = [PlayerKickState, PlayerSlashState, PlayerBlockState, PlayerDashState, PlayerHeavyState, PlayerPunchState, PlayerNun3State]
